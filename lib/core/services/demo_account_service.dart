...
class DemoAccountService {
  const DemoAccountService._();

  static const String patientEmail = 'abunael28@gmail.com';
  static const String doctorEmail = 'thebest102022@gmail.com';
  static const String organizationEmail = 'abunael29@gmail.com';

  static String get password => const String.fromEnvironment(
        AppConstants.demoPasswordEnvironmentKey,
        defaultValue: '',
      );
